...
function ChatUIScreen() {
  ...
  const clickBuy = (product, category) => {
    ...
    axios
      .post(
        'http://localhost:5000/savePurchase',
        {
  ...
  return (
    <div>
      <div className="msgs">
        {messages.map(
          ({ id, text, resImg, /*photoURL, uid,*/ messageType }) => (
            <div>
              ...
              <div
                ...
                className={`msg ${
                  ...
                  resImg || text.split('<br>').length > 0 ? 'img-reply' : ''
                }`}
              >
                  ...
                  {resImg ? (
                    <div style={{ width: '100%' }} className={'con-mid'}>
                      <img
                        ...
                        src={resImg}
                        className={'reply-img'}
                        style={{ margin: '0 20px 20px', borderRadius: '10px' }}
                      />
                    </div>
                  ) : (
                    ''
